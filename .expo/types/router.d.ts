...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/test` | `/test` | `/+html` | `/modal` | `/(tabs)/campaign` | `/campaign` | `/(tabs)/` | `/(tabs)` | `/(tabs)/diary` | `/diary` | `/(tabs)/discover` | `/discover` | `/(tabs)/profile` | `/profile`;
  // prettier-ignore
